...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LibOSXUnwind_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("a83860b7-747b-57cf-bf1f-3e79990d037f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LibOSXUnwind", artifacts_toml) for e in artifacts["LibOSXUnwind"]]
...
if best_platform === nothing
    @debug("Unable to load LibOSXUnwind; unsupported platform $(triplet(platform_key_abi()))")
else
